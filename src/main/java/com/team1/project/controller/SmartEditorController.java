...
public class SmartEditorController {
	...
	public void imgUpload(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			System.out.println("sFilname= " + sFilename);	
			...
			if(nCnt == 0) {
				...
				/*
				 * File realFile = new File(filePath, sRealFileNm); FileUploadDTO fileUploadDTO
				 * = FileUploadDTO.of(token, realFile.getAbsolutePath(), file2);
				 */
