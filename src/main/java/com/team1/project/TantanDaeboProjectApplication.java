...
//			ResponseEntity<Root> response = restTemplate.getForEntity("https://api.tripsoda.com/accompany/list?page=1&limit=24", Root.class);
//
//			Root root = response.getBody();
//
//			root.accompanyList
//					.forEach(accompany -> System.out.println(accompany.title));
//		};
//	}
//}
//
